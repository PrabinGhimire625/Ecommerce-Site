...
const Checkout = () => {
  ...
  <>
    <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
      <div className="mt-4  text-xs sm:mt-0 sm:ml-auto sm:text-base">
      </div>
    </div>
      ...
      <div className="mt-10 px-4 pt-8 lg:mt-0">
          ...
          {paymentMethod===PaymentMethod.COD ?(
            <button type='submit' className="mt-4 mb-8 w-full rounded-md bg-red-700 px-6 py-3 font-medium text-white">Place Order</button>
          ):(
